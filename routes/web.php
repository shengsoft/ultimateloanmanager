...
Route::get('dashboard', [
    ...
    function () {
        ...
        $company_email = \App\Models\Setting::where('setting_key', 'company_email')->first()->setting_value;
        $company_name = \App\Models\Setting::where('setting_key', 'company_name')->first()->setting_value;
        $message = \App\Models\Setting::where('setting_key', 'loan_payment_reminder_email_template')->first()->setting_value;
        $borrowers = \App\Models\Loan::where('branch_id', session('branch_id'))->where('status', 'disbursed')->where('reminder', 'yes')->get();
        //test mpesa here
        return view('dashboard', compact(
            'monthly_actual_expected_data', 'monthly_disbursed_loans_data', 'loan_statuses', 'borrowers', 'company_email', 'company_name', 'message'
        ));
    }
]);
...
Route::group(['prefix' => 'loan'], function () {
    ...
    //Reminders
    Route::post('borrower/reminder/{id}/send', 'LoanController@sendReminder');
    // Route::get('borrower/reminder/{id}/show', 'LoanController@previewSendReminder');
    // Route::get('borrower/reminder/{id}/edit', 'LoanController@editSendReminder');
    Route::get('borrower/reminder/{id}/print', 'LoanController@printSendReminder');
    Route::get('borrower/reminder/{id}/pdf', 'LoanController@pdfSendReminder');
    Route::get('borrower/reminder/{id}/delete', 'LoanController@deleteSendReminder');
    //comment routes
    ...
    //routes for loan overdue penalty method
