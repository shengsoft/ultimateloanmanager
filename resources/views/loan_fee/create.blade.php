        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <div class="radio">
                        <label>
                            <input class="styled" type="radio" name="loan_fee_type" id="inputFeeAmountFixed" value="fixed" checked="">
                    ...
                    <div class="radio">
                        <label>
                            <input class="styled" type="radio" name="loan_fee_type" id="inputFeeAmountPercentage" value="percentage">
