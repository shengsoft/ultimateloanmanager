    ...
    <div class="panel panel-white">
        ...
        <div class="panel-body">
            ...
            <!-- <div class="form-group">
                ...
                <div class="col-sm-10">
                    {!! Form::select('penalty_period',array('day'=>trans_choice('general.day',1),'week'=>trans_choice('general.week',1),'month'=>trans_choice('general.month',1),'year'=>trans_choice('general.year',1)),$loan_overdue_penalty->penalty_period, array('class' => 'form-control', 'placeholder'=>"",'required'=>'required')) !!}
                </div>
            </div> -->
            <div class="form-group">
