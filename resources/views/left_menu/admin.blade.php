                            ...
                            <ul class="treeview-menu">
                                ...
                                @if(Sentinel::hasAccess('loans.update'))
                                    <li><a href="{{ url('loan/loan_fee/data') }}"><i
                                                    class="fa fa-circle-o"></i> {{trans_choice('general.loan',1)}}  {{trans_choice('general.fee',2)}}
                                        </a></li>
                                @endif
                                <!-- @if(Sentinel::hasAccess('loans.update'))
                                    <li><a href="{{ url('loan/loan_overdue_penalty/data') }}"><i
                                                    class="fa fa-circle-o"></i> {{trans_choice('general.loan',1)}}  {{trans_choice('general.overdue',1)}}
                                                    {{trans_choice('general.penalty',1)}}
                                        </a></li>
                                @endif -->
                                <!-- @if(Sentinel::hasAccess('loans.update'))
                                    <li><a href="{{ url('loan/loan_status/data') }}"><i
                                                    class="fa fa-circle-o"></i> {{trans_choice('general.loan',1)}}  {{trans_choice('general.status',1)}}
                                        </a></li>
                                @endif -->
                                @if(Sentinel::hasAccess('loans.update'))
