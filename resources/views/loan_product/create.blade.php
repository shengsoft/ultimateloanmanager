    ...
    <div class="panel panel-white">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    {!! Form::select('cha',$charges,null, array('class' => 'form-control select2','placeholder'=>trans_choice('general.select',1).' '.trans_choice('general.charge',1), 'required'=>"required", 'id'=>'charges_dropdown')) !!}
                </div>
                <div class="col-sm-3">
