...
@section('content')
    <div class="panel panel-white">
        <div class="panel-heading">
            <h6 class="panel-title">{{trans_choice('general.edit',1)}} {{trans_choice('general.loan',1)}} {{trans_choice('general.product',1)}}</h6>
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-md-3">
                            {!! Form::text('default_principal',$loan_product->default_principal, array('class' => 'form-control touchspin', 'placeholder'=>trans_choice('general.default',1) ,'required'=>'required')) !!}
                        </div>
                        <div class="col-md-3">
                            {!! Form::text('minimum_principal',$loan_product->minimum_principal, array('class' => 'form-control touchspin', 'placeholder'=>trans_choice('general.min',1),'required'=>'required')) !!}
                        </div>
                        <div class="col-md-3">
                            {!! Form::text('maximum_principal',$loan_product->maximum_principal, array('class' => 'form-control touchspin', 'placeholder'=>trans_choice('general.max',1) ,'required'=>'required')) !!}
                        </div>
                        <div class="col-sm-3">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    {!! Form::number('default_loan_duration',$loan_product->default_loan_duration, array('class' => 'form-control','required'=>'required')) !!}
                </div>
                <div class="col-sm-3">
                    {!! Form::select('default_loan_duration_type',array('day'=>trans_choice('general.day',1).'(s)','week'=>trans_choice('general.week',1).'(s)','month'=>trans_choice('general.month',1).'(s)','year'=>trans_choice('general.year',1).'(s)'),$loan_product->default_loan_duration_type, array('class' => 'form-control','required'=>'required',"id"=>"inputMaxInterestPeriod")) !!}
                </div>
                <div class="col-sm-3">
                    <i class="icon-info3" data-toggle="tooltip"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-md-3">
                            {!! Form::text('default_interest_rate',$loan_product->default_interest_rate, array('class' => 'form-control touchspin', 'placeholder'=>trans_choice('general.default',1) ,'required'=>'required')) !!}
                        </div>
                        <div class="col-md-3">
                            {!! Form::text('minimum_interest_rate',$loan_product->minimum_interest_rate, array('class' => 'form-control touchspin', 'placeholder'=>trans_choice('general.min',1),'required'=>'required')) !!}
                        </div>
                        <div class="col-md-3">
                            {!! Form::text('maximum_interest_rate',$loan_product->maximum_interest_rate, array('class' => 'form-control touchspin', 'placeholder'=>trans_choice('general.max',1) ,'required'=>'required')) !!}
                        </div>
                        <div class="col-sm-3">
                            <i class="icon-info3" data-toggle="tooltip"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    {!! Form::select('interest_period',array('day'=>trans_choice('general.per_day',1),'week'=>trans_choice('general.per_week',1),'month'=>trans_choice('general.per_month',1),'year'=>trans_choice('general.per_year',1)),$loan_product->interest_period, array('class' => 'form-control','required'=>'required',"id"=>"inputDefaultInterestPeriod")) !!}
                </div>
                <div class="col-sm-3">
                    <i class="icon-info3" data-toggle="tooltip"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    {!! Form::number('grace_on_interest_charged',$loan_product->grace_on_interest_charged, array('class' => 'form-control')) !!}
                </div>
                <div class="col-sm-3">
                    <i class="icon-info3" data-toggle="tooltip"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    {!! Form::number('late_repayment_penalty_grace_period',$loan_product->late_repayment_penalty_grace_period, array('class' => 'form-control')) !!}
                </div>
                <div class="col-sm-3">
                    <i class="icon-info3" data-toggle="tooltip"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    {!! Form::number('after_maturity_date_penalty_grace_period',$loan_product->after_maturity_date_penalty_grace_period, array('class' => 'form-control')) !!}
                </div>
                <div class="col-sm-3">
                    <i class="icon-info3" data-toggle="tooltip"
                       title="Number of days before penalty is applied"></i>
            ...
            <div class="form-group">
                <label for="inputLoanRepaymentOrder"
                       class="col-sm-3 control-label">{{trans_choice('general.repayment',1)}} {{trans_choice('general.order',1)}}
                    *</label>

                <div class="col-xs-6">
                    {!! Form::select('repayment_order[]',$repayment_order,unserialize($loan_product->repayment_order), array('class' => 'form-control', 'placeholder'=>"","multiple"=>"" ,"id"=>"to" ,"size"=>"7")) !!}
                    <input class="btn btn-info" type="button" value="Up" onclick="up()">
                    <input class="btn btn-info" type="button" value="Down" onclick="down()">
                </div>
                <div class="col-md-3">
                    <i class="icon-info3" data-toggle="tooltip"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    {!! Form::select('accounting_rule',['cash_based'=>trans_choice('general.cash_based',1),'accrual_periodic'=>trans_choice('general.accrual_periodic',1),'accrual_upfront'=>trans_choice('general.accrual_upfront',1)],$loan_product->accounting_rule, array('class' => 'form-control select2','required'=>'required','id'=>'accounting_rule')) !!}
                </div>
                <div class="col-sm-3">
                    <i class="icon-info3" data-toggle="tooltip"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    {!! Form::select('chart_fund_source_id',$chart_assets,$loan_product->chart_fund_source_id, array('class' => 'form-control select2','placeholder'=>'','required'=>'required')) !!}
                </div>
                <div class="col-sm-3">
                    <i class="icon-info3" data-toggle="tooltip"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    {!! Form::select('chart_loan_portfolio_id',$chart_assets,$loan_product->chart_loan_portfolio_id, array('class' => 'form-control select2','placeholder'=>'','required'=>'required')) !!}
                </div>
                <div class="col-sm-3">
                    <i class="icon-info3" data-toggle="tooltip"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    {!! Form::select('chart_receivable_interest_id',$chart_assets,$loan_product->chart_receivable_interest_id, array('class' => 'form-control select2','placeholder'=>'','required'=>'required')) !!}
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    {!! Form::select('chart_receivable_fee_id',$chart_assets,$loan_product->chart_receivable_fee_id, array('class' => 'form-control select2','placeholder'=>'','required'=>'required')) !!}
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    {!! Form::select('chart_receivable_penalty_id',$chart_assets,$loan_product->chart_receivable_penalty_id, array('class' => 'form-control select2','placeholder'=>'','required'=>'required')) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    {!! Form::select('chart_loan_over_payments_id',$chart_liability,$loan_product->chart_loan_over_payments_id, array('class' => 'form-control select2','placeholder'=>'','required'=>'required')) !!}
                </div>
                <div class="col-sm-3">
                    <i class="icon-info3" data-toggle="tooltip"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    {!! Form::select('chart_income_interest_id',$chart_income,$loan_product->chart_income_interest_id, array('class' => 'form-control select2','placeholder'=>'','required'=>'required')) !!}
                </div>
                <div class="col-sm-3">
                    <i class="icon-info3" data-toggle="tooltip"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    {!! Form::select('chart_income_fee_id',$chart_income,$loan_product->chart_income_fee_id, array('class' => 'form-control select2','placeholder'=>'','required'=>'required')) !!}
                </div>
                <div class="col-sm-3">
                    <i class="icon-info3" data-toggle="tooltip"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    {!! Form::select('chart_income_penalty_id',$chart_income,$loan_product->chart_income_penalty_id, array('class' => 'form-control select2','placeholder'=>'','required'=>'required')) !!}
                </div>
                <div class="col-sm-3">
                    <i class="icon-info3" data-toggle="tooltip"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    {!! Form::select('chart_income_recovery_id',$chart_income,$loan_product->chart_income_recovery_id, array('class' => 'form-control select2','placeholder'=>'','required'=>'required')) !!}
                </div>
                <div class="col-sm-3">
                    <i class="icon-info3" data-toggle="tooltip"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    {!! Form::select('chart_loans_written_off_id',$chart_expenses,$loan_product->chart_loans_written_off_id, array('class' => 'form-control select2','placeholder'=>'','required'=>'required')) !!}
                </div>
                <div class="col-sm-3">
                    <i class="icon-info3" data-toggle="tooltip"
