...
@section('content')
    <div class="panel panel-white">
        <div class="panel-heading">
            <h3 class="panel-title">{{trans_choice('general.edit',1)}} {{trans_choice('general.payroll',1)}} {{trans_choice('general.template',1)}}</h3>
        ...
        <div class="panel-body">
              ...
              <div class="col-md-6">
                <div class="box box-solid box-primary">
                  <div class="box-header">
                      <h6 class="panel-title">{{trans_choice('general.payroll',1)}} {{trans_choice('general.date',1)}}</h6>
                  </div>
                  <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="box box-solid box-primary">
                        <div class="box-header">
                            <h6 class="panel-title">{{trans_choice('general.addition',2)}}</h6>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-md-6">
                    <div class="box box-solid box-danger">
                        <div class="box-header">
                            <h6 class="panel-title">{{trans_choice('general.deduction',2)}}</h6>
                        </div>
                        <div class="panel-body">
