...
class ReportController extends Controller
{
    ...
    public function trial_balance_excel(Request $request)
    {
        ...
        if (!empty($start_date)) {
            ...
            //     })->download('xls');
            Excel::download($data, trans_choice('general.trial_balance', 1) . ' : ' . $request->end_date. '.xls', 'Xls');
        }
    }
    ...
    public function trial_balance_csv(Request $request)
    {
        ...
        if (!empty($start_date)) {
            ...
            //     })->download('csv');
            Excel::download($data, trans_choice('general.trial_balance', 1) . ' : ' . $request->end_date. '.csv', 'Csv');
        }
    }
    ...
    public function income_statement_excel(Request $request)
    {
        ...
        if (!empty($start_date)) {
            ...
            //     })->download('xls');
            Excel::download($data, trans_choice('general.income', 1) . ' ' . trans_choice('general.statement',
                    1) . ' : ' . $request->end_date. '.xls', 'Xls');
        }
    }
    ...
    public function balance_sheet_excel(Request $request)
    {
        ...
        if (!empty($start_date)) {
            ...
            //     })->download('xls');
            Excel::download($data, trans_choice('general.balance', 1) . ' ' . trans_choice('general.sheet',
                    1) . ' : ' . $request->start_date. '.xls', 'Xls');
        }
    }
    ...
    public function expected_repayments_excel(Request $request)
    {
        ...
        //     })->download('xls');
        Excel::download($data, trans_choice('general.expected', 1) . ' ' . trans_choice('general.repayment',
                    2). '.xls', 'Xls');
    }
    ...
    public function repayments_report_excel(Request $request)
    {
        ...
        if (!empty($start_date)) {
            ...
            //     })->download('xls');
            Excel::download($data, trans_choice('general.repayment', 2) . ' ' . trans_choice('general.report',
                    2). '.xls', 'Xls');
        }
    ...
    public function collection_sheet_excel(Request $request)
    {
        ...
        if (!empty($start_date)) {
            ...
            //     })->download('xls');
            Excel::download($data, trans_choice('general.collection', 1) . ' ' . trans_choice('general.sheet',
                    2). '.xls', 'Xls');
        }
    ...
    public function arrears_report_excel(Request $request)
    {
        ...
        if (!empty($end_date)) {
            ...
            //     })->download('xls');
            Excel::download($data, trans_choice('general.arrears', 1) . ' ' . trans_choice('general.report',
                    2). '.xls', 'Xls');
        }
    ...
    public function disbursed_loans_pdf(Request $request)
    {
        ...
        if (!empty($end_date)) {
            ...
            $pdf = PDF::loadView('loan_report.disbursed_loans_pdf', compact('start_date',
                'end_date', 'data'));
            //$pdf->setPaper('A4', 'landscape');
    ...
    public function disbursed_loans_excel(Request $request)
    {
        ...
        if (!empty($end_date)) {
            ...
            //     })->download('xls');
            Excel::download($data, trans_choice('general.disbursed', 1) . ' ' . trans_choice('general.loan',
                    2). '.xls', 'Xls');
        }
    ...
    public function provisioning_excel(Request $request)
    {
        ...
        if (!empty($end_date)) {
            ...
            //     })->download('xls');
            Excel::download($data, trans_choice('general.provisioning', 1) . ' ' . trans_choice('general.report',
                    2). '.xls', 'Xls');
        }
    ...
    public function products_summary_excel(Request $request)
    {
        ...
        if (!empty($end_date)) {
            ...
            //     })->download('xls');
            Excel::download($data, trans_choice('general.product', 2) . ' ' . trans_choice('general.summary',
                    1). '.xls', 'Xls');
        }
    ...
    public function products_summary_csv(Request $request)
    {
        ...
        if (!empty($end_date)) {
            ...
            //     })->download('csv');
            Excel::download($data, trans_choice('general.product', 2) . ' ' . trans_choice('general.summary', 1). '.csv', 'Csv');
        }
    ...
    public function savings_transactions_excel(Request $request)
    {
        ...
        if (!empty($start_date)) {
            ...
            //     })->download('xls');
            Excel::download($data, trans_choice('general.saving', 2) . ' ' . trans_choice('general.transaction',
                    2). '.xls', 'Xls');
        }
